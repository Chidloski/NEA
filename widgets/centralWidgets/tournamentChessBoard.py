...
class invisibleButton(QtWidgets.QPushButton):
    def setHidden(self, hiding):
        if hiding:
...
class Ui_tournamentChessBoard(QtWidgets.QWidget):
    ...
    def setupUi(self, dashboard):
        self.setObjectName("tournamentChessBoard")
        self.resize(560, 560)
        ...
        self.playAgainButton = invisibleButton(self)
        ...
        self.drawMessage.setWordWrap(True)
        self.drawMessage.setHidden(True)
    ...
    def retranslateUi(self):
        ...
        self.a8.setText(_translate("tournamentChessBoard", "8"))
        self.a7.setText(_translate("tournamentChessBoard", "7"))
        self.a6.setText(_translate("tournamentChessBoard", "6"))
        self.a5.setText(_translate("tournamentChessBoard", "5"))
        self.a4.setText(_translate("tournamentChessBoard", "4"))
        self.a3.setText(_translate("tournamentChessBoard", "3"))
        self.a2.setText(_translate("tournamentChessBoard", "2"))
        self.a1.setText(_translate("tournamentChessBoard", "a1"))
        self.b1.setText(_translate("tournamentChessBoard", "b"))
        self.c1.setText(_translate("tournamentChessBoard", "c"))
        self.d1.setText(_translate("tournamentChessBoard", "d"))
        self.e1.setText(_translate("tournamentChessBoard", "e"))
        self.f1.setText(_translate("tournamentChessBoard", "f"))
        self.g1.setText(_translate("tournamentChessBoard", "g"))
        self.h1.setText(_translate("tournamentChessBoard", "h"))
        self.queenButton.setText(_translate("tournamentChessBoard", "Queen"))
        self.knightButton.setText(_translate("tournamentChessBoard", "Knight"))
        self.gameOverLabel.setText(_translate("tournamentChessBoard", "game over"))
        self.playAgainButton.setText(_translate("tournamentChessBoard", "Play Again!"))