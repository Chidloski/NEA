...
# show a game over screen if a puzzle results in a checkmate or stalemate
# thus i override the method within the game over label and button to stop them from being shown by unhiding them
...
class Ui_puzzleChessBoard(QtWidgets.QWidget):

    def returnPgn(self, pgn):
        if not (pgn == "" or self.promotionLabel.isVisible() or self.robotMove):
            newMove(self.dashboard, pgn)
    ...
    def setupUi(self, dashboard):
        ...
        self.gameOverLabel = invisibleLabel(self)
