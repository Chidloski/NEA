...
from widgets.utilityWidgets.functions.tournamentFunctions import *
...
class Ui_tournamentStage4(QtWidgets.QWidget):

    def setupUi(self, dashboard, baseWindow):
        # sizing of the widget
        self.setObjectName("tournamentStage4Page")
        self.resize(230, 560)
    ...
    def retranslateUi(self):
        ...
        self.currentUserLabel.setText(_translate("tournamentStage4Page", "current user:"))
        self.currentUserRatingLabel.setText(_translate("tournamentStage4Page", "Rating"))
        self.currentUserRatingOutcome.setText(_translate("tournamentStage4Page", "Rating Change:"))
        self.currentUserRatingDelta.setText(_translate("tournamentStage4Page", "Win +5 / Draw +0 / Loss -1"))
        self.opponentUserLabel.setText(_translate("tournamentStage4Page", "current user:"))
        self.opponentUserRatingLabel.setText(_translate("tournamentStage4Page", "Rating"))
        self.opponentUserRatingOutcome.setText(_translate("tournamentStage4Page", "Rating Change:"))
        self.opponentUserRatingDelta.setText(_translate("tournamentStage4Page", "Win +5 / Draw +0 / Loss -1"))
        self.PGNLabel.setText(_translate("tournamentStage4Page", "PGN:"))
        self.moveset.setText(_translate("tournamentStage4Page", ""))
        self.drawButton.setText(_translate("tournamentStage4Page", "Offer Draw"))
        self.resignButton.setText(_translate("tournamentStage4Page", "Resign"))